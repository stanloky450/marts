...
export default function VendorsPage() {
	...
	const handleToggleStatus = async (vendorId: string, newStatus: string) => {
		// optimistic UI: set loading for vendor
		try {
			// show small inline spinner by temporarily setting a loading flag on that vendor
